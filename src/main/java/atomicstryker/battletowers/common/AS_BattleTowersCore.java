...
public class AS_BattleTowersCore {
    ...
    @SidedProxy(
        clientSide = "atomicstryker.battletowers.client.ClientProxy",
        serverSide = "atomicstryker.battletowers.common.CommonProxy")
    ...
    public void onClientConnected(ClientConnectedToServerEvent event) {
        System.out.println(
            FMLCommonHandler.instance()
                .getEffectiveSide() + " registered ClientConnectedToServerEvent, sending packet to server");
    ...
    public void load(FMLInitializationEvent evt) {
        ...
        EntityRegistry
            .registerGlobalEntityID(AS_EntityGolem.class, "Battletower Golem", golemEntityID, 0xA0A0A0, 0x808080);
    ...
    public void modsLoaded(FMLPostInitializationEvent evt) {
        ...
        floorItemManagers[0] = new TowerStageItemManager(
            configuration
                .get(
                    "BattleTowerChestItems",
                    "Floor 1",
                    "stick-0-75-5-6;wheat_seeds-0-75-3-5;planks-0-75-5-6;reeds-0-75-3-5")
                .getString());
        ...
        floorItemManagers[1] = new TowerStageItemManager(
            configuration
                .get(
                    "BattleTowerChestItems",
                    "Floor 2",
                    "stone_pickaxe-0-50-1-1;stone_axe-0-50-1-1;torch-0-80-3-3;stone_button-0-50-2-2")
                .getString());
        ...
        // wool-0-25-2-2 wool
        floorItemManagers[2] = new TowerStageItemManager(
            configuration
                .get("BattleTowerChestItems", "Floor 3", "bowl-0-75-2-4;coal-0-90-4-4;string-0-80-5-5;wool-0-75-2-2")
                .getString());
        ...
        floorItemManagers[3] = new TowerStageItemManager(
            configuration
                .get(
                    "BattleTowerChestItems",
                    "Floor 4",
                    "glass-0-75-3-3;feather-0-75-4-4;bread-0-75-2-2;apple-0-75-2-2")
                .getString());
        ...
        floorItemManagers[4] = new TowerStageItemManager(
            configuration
                .get(
                    "BattleTowerChestItems",
                    "Floor 5",
                    "brown_mushroom-0-75-2-2;red_mushroom-0-75-2-2;sapling-0-90-3-3;wheat-0-75-4-4")
                .getString());
        ...
        floorItemManagers[5] = new TowerStageItemManager(
            configuration
                .get(
                    "BattleTowerChestItems",
                    "Floor 6",
                    "sign-0-50-1-2;fishing_rod-0-75-1-1;pumpkin_seeds-0-60-2-2;melon_seeds-0-60-3-3")
                .getString());
        ...
        floorItemManagers[6] = new TowerStageItemManager(
            configuration
                .get(
                    "BattleTowerChestItems",
                    "Floor 7",
                    "iron_sword-0-60-1-1;gunpowder-0-75-3-3;leather-0-75-4-4;fish-0-75-3-3;dye-0-60-1-2")
                .getString());
        ...
        floorItemManagers[7] = new TowerStageItemManager(
            configuration.get(
                "BattleTowerChestItems",
                "Floor 8",
                "chainmail_helmet-0-40-1-1;chainmail_chestplate-0-40-1-1;chainmail_leggings-0-40-1-1;chainmail_boots-0-40-1-1;ChestGenHook:dungeonChest:3")
                .getString());
        ...
        floorItemManagers[8] = new TowerStageItemManager(
            configuration.get(
                "BattleTowerChestItems",
                "Floor 9",
                "bookshelf-0-70-1-3;redstone_lamp-0-60-2-2;waterlily-0-75-3-3;brewing_stand-0-50-1-1;ChestGenHook:dungeonChest:5")
                .getString());
        ...
        floorItemManagers[9] = new TowerStageItemManager(
            configuration.get(
                "BattleTowerChestItems",
                "Top Floor",
                "ender_pearl-0-50-2-2;diamond-0-70-2-2;redstone-0-75-5-5;gold_ingot-0-90-8-8;ChestGenHook:dungeonChest:7")
                .getString());
        configuration.save();
    }
    ...
    public void loadForgeConfig() {
        configuration.load();
        minDistanceFromSpawn = configuration.get("MainOptions", "Minimum Distance of Battletowers from Spawn", 96)
            .getInt();
        minDistanceBetweenTowers = Integer.parseInt(
            configuration.get("MainOptions", "Minimum Distance between 2 BattleTowers", 196)
                .getString());
        towerDestroyerEnabled = Integer.parseInt(
            configuration.get("MainOptions", "Tower Destroying Enabled", 1)
                .getString());
        itemGenerateAttemptsPerFloor = configuration.get("BattleTowerChestItems", "Item Generations per Floor", "7")
            .getInt();
        chanceTowerIsUnderGround = configuration.get("MainOptions", "chanceTowerIsUnderGround", 15)
            .getInt();
        noGolemExplosions = configuration.get("MainOptions", "noGolemExplosions", false)
            .getBoolean(false);
        towerFallDestroysMobSpawners = configuration
            .get(
                "MainOptions",
                "towerFallDestroysMobSpawners",
                false,
                "Destroy all Mob Spawners in Tower Area upon Tower Fall?")
            .getBoolean(false);
        golemEntityID = configuration.get(Configuration.CATEGORY_GENERAL, "Golem Entity ID", 186)
            .getInt();
        configuration.save();
    }
